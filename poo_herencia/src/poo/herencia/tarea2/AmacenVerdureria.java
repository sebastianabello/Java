package poo.herencia.tarea2;

public class AmacenVerdureria {
    ...
    public static void main(String[] args) {
        ...
        productos[4] = new Lacteo(1000, 32, "Leche Sabor Chocolate ", 1150);
        productos[5] = new Lacteo(1000, 37, "Yoghurt Batido ", 1190);
